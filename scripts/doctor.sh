...
check_base_workflows() {
  ...
  check 'ChatGPT en segundo plano' "$repo_root/scripts/tests/test_chatgpt_background.sh"
  check 'Orca manual de reserva' "$repo_root/scripts/tests/test_orca_background.sh"
