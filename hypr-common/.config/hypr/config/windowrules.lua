...
hl.window_rule({
    ...
    keep_aspect_ratio = true,
    size = { 360, 202 },
    move = "monitor_w-380 monitor_h-222",
    pin = true,
})
hl.window_rule({
...
hl.window_rule({ match = { class = "^(org\\.qutebrowser\\.qutebrowser|brave-browser|chromium|firefox|zen)$" }, opacity = "1.0 override" })
...
hl.window_rule({ match = { class = "^(org.kde.haruna|.*plex.*|org\\.kde\\.gwenview|.*vlc.*)$" }, opacity = "1.0 override" })
